...
<body>
        ...
        <div class="slider">
            <div class="Modern-Slider content-section" id="top">
                ...
                <div class="item item-1">
                    ...
                    <div class="info">
                        <div>
                          <h1>Yimian Cloud<br></h1>
                          <p>Aimming to provide the best cloud stroage service.<br>
               			  Click the following button for more infomation.</p>
                          <div class="white-button button">
                              <a href="https://cloud.yimian.xyz">Discover More</a>
                          </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="item item-2">
                    <div class="img-fill">
                        ...
                        <div>
                          <h1>Yimian SSR<br></h1>
                          <p>Experience Service OUT OF CHINA for FREE.
						  <br>Runing with 10MB/s STABLY!</p>
                          
                          <div class="white-button button">
                              <a href="https://cn.yimian.xyz/ssr">Discover More</a>
                          </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="item item-3">
                    <div class="img-fill">
                        ...
                        <div class="info">
                        <div>
                          <h1>Yimian Video<br></h1>
                          <p>Share Video with the one You Love!</p>
                          
                          <div class="white-button button">
                              <a href="https://www.yimian.xyz/video">Discover More</a>
                          </div>
                        </div>
                        </div>
                    </div>
            ...
            <section id="featured" class="content-section">
                ...
                <div class="section-content">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="image">
                                <img src="index/img/featured_1.jpg" alt="">
                        ...
                        <div class="item">
                            <div class="image">
                                <img src="index/img/featured_2.jpg" alt="">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="image">
                                <img src="index/img/featured_3.jpg" alt="">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                ...
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="index/img/portfolio_big_1.jpg" data-lightbox="image"><img src="index/img/portfolio_1.jpg" alt="image 1"></a>
                                </div>
                            </div>
                            <div class="item second-item">
                                <div class="col-md-4">
                                    <a href="index/img/portfolio_big_2.jpg" data-lightbox="image"><img src="index/img/portfolio_2.jpg" alt="image 2"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="index/img/portfolio_big_3.jpg" data-lightbox="image"><img src="index/img/portfolio_3.jpg" alt="image 3"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="index/img/portfolio_big_4.jpg" data-lightbox="image"><img src="index/img/portfolio_4.jpg" alt="image 4"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="index/img/portfolio_big_5.jpg" data-lightbox="image"><img src="index/img/portfolio_5.jpg" alt="image 5"></a>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<source src="https://uk.cloud.yimian.xyz/index.php/s/WFF7kKrbB9XLCCH/download?path=%2F&files=1.mp4" type="video/mp4" />
		</video>
                            </div>
                        </div>
                    </div>
            ...
            <section id="blog" class="content-section">
                <div class="section-heading">
					<h1><a href="blog/">Blog<br><em>Entries</em></a></h1>
                            ...
                            <section id="first-tab-group" class="tabgroup">
                                <div id="tab1">
                                    <ul>
                                        <li>
                                            <div class="item">
                                                <img src="index/img/blog_1.jpg" alt="">
                                                <div class="text-content">
                                        ...
                                        <li>
                                            <div class="item">
                                                <img src="index/img/blog_2.jpg" alt="">
                                                <div class="text-content">
                                        ...
                                        <li>
                                            <div class="item">
                                                <img src="index/img/blog_3.jpg" alt="">
                                                <div class="text-content">
                                                  <h4>Sed at massa turpis</h4>

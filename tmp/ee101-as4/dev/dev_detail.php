	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="dev_post.php"><i class="fa fa-fw fa-folder"></i> 已完成ee101_as4_functions</a>
                </li>
...
echo "</br>";
echo "</br>Function: </br>
<textarea style=\"width:80%;height:150px\">".$code."</textarea></br></br>";
if($like>0)
echo "</br>已获".$like."个赞！</br>";

$conn->close();
?></p>
						
			<form action="dev_detail2.php" method="POST">		
			<input type="hidden" name="name5" value="<?php echo $name5?>"/>
			<input type="hidden" name="like" value="<?php echo $like?>"/>
			<button type="submit" >赞一个</button>
			</form>		

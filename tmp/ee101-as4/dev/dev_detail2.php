...
if(isset($_COOKIE[md5($name5)])&&$_COOKIE[md5($name5)]==$name) {echo "<script>alert('您已经赞过了！');window.location.href='dev_detail.php?name=$name5'</script>";exit();}
...
$like++;
            ...
            $sql="UPDATE ee101_as4_functions set lke=$like where name='$name5'"; 
 
	
	if ($conn->query($sql) === TRUE) {
		setcookie(md5($name5),$_COOKIE['usr'], time()+3600*24*50);
		echo "<script>alert('点赞成功！');window.location.href='dev_detail.php?name=$name5'</script>";

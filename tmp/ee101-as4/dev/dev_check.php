            ...
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="dev_post.php"><i class="fa fa-fw fa-folder"></i> 已完成的functions</a>
				                ...
				                <li>
                    <a href="dev_rank.php"><i class="fa fa-fw fa-folder"></i> Other Developers </a>
                </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <h1 class="page-header">已完成 Functions</h1>  <p class="lead">
                        <?php
$servername = "114.116.65.152";
$username = "yimian";
$password = "Lymian0904@112";
...
$sql = "SELECT * FROM ee101_as4_functions where host!='' AND chck=0 AND endtime!='0000-00-00 00:00:00'";
...
echo "<a href=";
		$url="dev_check1.php?name=" . $row['name']."&from=1";
		$str='"';
		echo "$str";
		echo "$url";
		echo "$str";
